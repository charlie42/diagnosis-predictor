...
def get_feature_subsets_and_score_from_rfe_then_sfs(diag, best_estimators, datasets, number_of_features_to_check):
    ...
    feature_subsets, score = models.get_feature_subsets_and_score_from_sfs(diag, best_estimators, number_of_features_to_check, X_train_top_n_features, y_train)
    return feature_subsets, score