...
def set_up_directories():
    ...
    input_models_dir = models.get_newest_dir_in_dir(data_dir + "models/train_models/")
    input_reports_dir = models.get_newest_dir_in_dir(data_dir+ "reports/identify_feature_subsets/")
